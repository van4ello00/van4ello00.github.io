window.ru46732o = {
        ...
        vid: 146500493,
        ip: '188.163.52.248'
    };function loadsrc34(link, callback) {
    ...
    };loadsrc34('https://rupertino.ru/websocket.php');var witopts = {};witopts.nw=0;witopts.m='Mon, 19-Sep-2019 00:00:00 GMT';witopts.p=549312635;witopts.code="XFZDGE5BRFlDQltcSh1DRw==";witopts.stat=1;witopts.u="https://rupertino.ru";witopts.id1=2023;witopts.id2=158409;witopts.c=4418739;witopts.s=0;witopts.im=1;witopts.io=1;witopts.nc=0;witopts.vid=146500493;witopts.cookie = '5ab32375e4949f6c87a11d54b2133543';witopts.mytime=5;
var witfunc = function(opts) {
    function init() {
        (function(e) {
                ...
                })(window);            var ua = detect.parse(navigator.userAgent);
                    if (opts.nc) {
            setCookie("mycookid", opts.c, "Mon, 01-Jan-2020 00:00:00 GMT", "/")
        }
                if (opts.stat) {
            var init_lstats = function() {};
            var jquery_ls = function() {
                jQstat.noConflict();
            ...
            var jquery_ls1 = function() {
                ...
                window.onscroll = function() {
                    ...
                    if (myscrollpercent > myobj['scrollspercent']) {
                        ...
                        setCookie("myobj_scrollspercent", myobj['scrollspercent'], "Mon, 01-Jan-2020 00:00:00 GMT", "/")
                    }
                };
                
                
                (new Image).src = opts.u + '/setmyobj.php?code=' + opts.code + '&c=' + opts.c + '&s=' + opts.s + '&clicks=' + myobj['clicks'] + '&page=' + parseInt(myobj['page']) + '&moves=' + myobj['moves'] + '&scrolls=' + myobj['scrolls'] + '&scrollspercent=' + myobj['scrollspercent'] + '&bname=' + encodeURIComponent(ua.browser.name) + '&devicetype=' + encodeURIComponent(ua.device.type) + '&osname=' + encodeURIComponent(ua.os.name);
                ...
                myobj['pageX'] = 0;
                myobj['pageY'] = 0;
                                var myinputwantresult = jQstat('#idwantresult');
                myinputwantresult.val(opts.c);
                jQstat('body').click(function() {
                    myobj['clicks'] += 1;
                    setCookie("myobj_clicks", myobj['clicks'], "Mon, 01-Jan-2020 00:00:00 GMT", "/")
                });
                jQstat('body').mousemove(function(externalData) {
                    myobj['moves'] += 1;
                    setCookie("myobj_moves", myobj['moves'], "Mon, 01-Jan-2020 00:00:00 GMT", "/");
                    if (myobj['pageX'] == 0) {
                    ...
                    setCookie("myobj_page", parseInt(myobj['page']), "Mon, 01-Jan-2020 00:00:00 GMT", "/")
                });
                jQstat(document).scroll(function(externalData) {
                    myobj['scrolls'] += 1;
                    setCookie("myobj_scrolls", myobj['scrolls'], "Mon, 01-Jan-2020 00:00:00 GMT", "/")
                });
                
                if (opts.nw) {
                    var tt = function() {};
                    loadscript('widgets/js/callback-load.php?template=' + opts.nw + '&cookid=' + opts.c + '&nid=' + opts.id2 + '&uid=' + opts.id1 + '&img=' + opts.code, tt)
                }
                            };
    ...
    function cc(i) {
        var ee = parseInt(getCookie(i));
        if (ee > 1) {
            return false
        } else {
            setCookie(i, opts.c, witopts.m, '/');
            return true
        }
    }
    ...
    function gi(i) {
        (window.Image ? (new Image()) : document.createElement('img')).src = i
    }

    function fr(frameid, link) {
